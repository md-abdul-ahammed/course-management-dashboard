      ...
      >
        ...
        <div className="bg-white w-10/12 mt-12 sm:mt-20 block m-auto p-7   sm:p-16 rounded-3xl">
          ...
          <section className="px-2">
            <h2 className="text-violet text-2xl sm:text-4xl font-bold py-6">
              Intent:
            </h2>
            <p className="text-lg">
          ...
          <section className="px-2">
            ...
            <p className="text-lg ">
              ...
              interact or connect with or link to the Site via integrated social
              networking tools; and post comments to the Site.
            </p>
          </section>
