...
import EmailChange from "../../components/MerchantDashboard/Setting/EmailChange";
import OtpHandle from "../../components/MerchantDashboard/Setting/OtpHandle";
import PasswordChange from "../../components/MerchantDashboard/Setting/PasswordChange";
...
const Setting = () => {
  ...
  useEffect(() => {
    const userDataFunction = async () => {
      const ID = window.localStorage.getItem("OWNER_ID");
      console.log(ID);
      try {
        axios
          .get(`${host}/users/id?id=${ID}`, {
            headers: {
           ...
           */}
            ...
            <div>
              <p
                ...
                className="text-violet font-bold ml-10 mt-4 cursor-pointer"
              >
                Forgot Password ?
              </p>
            </div>
                  ...
                  >
                    ...
                    {/* {!mobileCode && !emailCode ? (
                      <>
                        ...
                        <div className="">
                          <button
                            className="border mb-3 bg-violet rounded-lg text-white py-2   w-full"
                            onClick={handleOtp}
                          >
