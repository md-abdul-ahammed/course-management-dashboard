    ...
    <React.Fragment>
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-4">
              ...
              <div className="flex flex-col items-start justify-center lg:w-1/2 space-y-4 pt-6">
                <label className="inline-block cursor-pointer">
                  <div className="flex bg-violet text-white space-x-2 rounded-lg px-4 py-2 items-center">
                    <AiOutlinePlus />
      ...
      <div className="flex space-x-4 items-center py-4 px-6">
        <button
          ...
          className="px-4  text-sm py-2 border-violet text-violet border-2 w-1/2 rounded-lg"
        >
          Discard Information
        </button>
        <button
          onClick={(e) => handleSubmit(e)}
          className="px-4  text-sm py-2 border-violet bg-violet text-white border-2 w-1/2 rounded-lg"
        >
          Save Changes
        </button>
      </div>
