...
import CommentsNotification from "../../components/Notifications/CommentsNotification";
import OstelloNotification from "../../components/Notifications/OstelloNotification";
import SalesNotification from "../../components/Notifications/SalesNotification";
import userImg from '../../assets/merchantDashboard/Accountancy/Kazi Mohammad Fahad Kibria.png'
import {
    ...
    <section className={`py-5 px-5 lg:px-14`} style={{ height: "100%" }}>
      ...
      <div  className=" ">
        ...
        <div className="flex flex-col lg:flex-row items-end lg:items-center lg:gap-10 text-base ">
          <div
            className={`${
              activeTab === "All" ? "bg-violet text-white" : "bg-white text-black"
          ...
          <div
            className={`${
              activeTab === "Sales" ? "bg-violet text-white" : "bg-white text-black"
            } w-28  hidden lg:block rounded-lg py-2 text-center`}
            onClick={() => {
              setActiveTab("Sales");
            }}
          ...
          <div
            className={`${
              activeTab === "Ostello" ? "bg-violet text-white" : "bg-white text-black"
            } w-28  hidden lg:block  rounded-lg py-2 text-center`}
            onClick={() => {
          ...
          <div
            className={`${
              activeTab === "Comment" ? "bg-violet text-white" : "bg-white text-black"
            } w-28   hidden lg:block rounded-lg py-2 text-center`}
            onClick={() => {
        ...
        <button className="font-medium border border-violet  px-3 py-2 text-violet border-4 hidden sm:block rounded-2xl">Delete All</button>
