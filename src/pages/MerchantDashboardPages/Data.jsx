          ...
          <>
            ...
            >
              ...
              <div className="flex jusify-center  items-center">
                ...
                <div className="border bg-violet rounded-lg text-white py-1 m-auto px-10">
                  Delete
                </div>
              </div>
            </div>
...
//             </button>
//           </div>
//           <div className={`py-4 px-2 text-sm bg-white text-violet`}>
//             Upload here
//           </div>
//           <div className={`py-4 px-2 text-sm bg-light-gray text-violet`}>
//             Upload here
//           </div>
//           <div className={`py-4 px-2 text-sm bg-white text-violet`}>
//             Upload here
...
//             </p>
//             <p className="">
//               <span className="text-violet underline">Click here</span> to start
//               posting
//             </p>
//           </div>
//         </div>
