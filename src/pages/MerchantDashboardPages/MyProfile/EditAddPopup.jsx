...
const EditAddPopup = ({
  ...
  const [input3, setInput3] = useState(activeFaculty?.overview)
      ...
      >
        ...
        <div className='space-y-3 lg:space-y-4'>
          ...
          <div className='border h-28 w-full lg:my-3 relative rounded-lg'>
            {!filePath ?? activeFaculty.src ? (
              <img className='h-28 w-full' src={activeFaculty.src} alt='' />
            ) : (
              ''
            )}
            <MdAddPhotoAlternate
        ...
        <button
          ...
          onClick={(e) => {
            e.preventDefault()
            console.log(filePath, input1, input2, input3)
            if (filePath && input1 && input2 && input3) {
              setShowPopUp1(false)
