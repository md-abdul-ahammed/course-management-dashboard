        ...
        <div className='offerBG  '>
          ...
          >
            ...
            <div className='flex'>
              <Link
                to={'/student-sign-up'}
                className='lg:px-8 px-10 py-2 text-lg lg:text-2xl mx-auto text-[#7D23E0]  bg-[#ffff] rounded-lg font-bold active:opacity-80 hover:scale-105 transition-all ease-linear duration-300 '
              >
                Sign Up
              </Link>
            </div>
