      ...
      <form onSubmit={handleEmailChanging}>
        <div className="email bg-white pl-5 p-3 rounded-xl  flex justify-between items-center cursor-pointer border border-ghost">
          <div className="w-11/12">
            ...
            <input
              ...
              onBlur={(e) => setChangeEmail(e.target.value)}
              type="text"
              id="base-input"
              className="bg-gray-50 border-none focus:outline-none border-gray-300 text-gray-900 w-full px-1 py-2 text-xl font-medium"
            />
          </div>
        </div>
        ...
        <div className="btn flex mt-5 justify-end">
          <button
            ...
            className="text-white bg-ghost  hover:bg-violet px-3  py-3 rounded-lg mr-2 "
          >
            Cancel
          </button>
          <input
            type="submit"
            value="Save Changes"
            className="text-white bg-violet px-3 py-3 rounded-lg cursor-pointer"
          />
        </div>
      </form>
    </div>
