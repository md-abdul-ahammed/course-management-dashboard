    ...
    <div className="grid grid-cols-6 md:gap-4">
      <div className=" bg-white p-4 rounded-2xl col-span-6 lg:col-span-6 md:col-span-3">
              ...
              <div className="share flex justify-between items-center mt-5 px-2">
                <div className="flex">
                  ...
                  <div className="texts ml-4">
                    <h2 className="text-sm">{s.courseName}</h2>
                ...
                <div className="texts">
                  <h2 className="text-2xl text-right sm:text-3xl font-bold">
                    ₹ {s.cost}
                  </h2>
                  <h3 className="price-rs text-sm ">
                    {s.percentage}% of RS.{s.rs}
                  </h3>
                </div>
              </div>
            ))
        ...
        <div className="see-all text-right">
          <a href="" className="text-xs  text-cyan-500 btn">
            See All
          </a>
        </div>
      </div>
            ...
            .map((t) => (
              <div className="share flex justify-between items-center mt-5 px-2">
                <div className="flex">
                  <img src={""} className="share-image" alt="" />
                  <div className="texts ml-4">
                    <h2 className="text-sm">{t.courseName}</h2>
                    <h3 className="text-xs" style={{ color: "#8E8E8E" }}>
