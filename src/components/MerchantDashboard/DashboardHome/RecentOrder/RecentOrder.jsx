      ...
      <div className=" bg-white p-4 rounded-2xl col-span-6 lg:col-span-6 md:col-span-3">
        <div className="flex  justify-between">
          ...
          <div className="select-dropdown">
            <select>
              <option className="option" value="Option 1">
                Today
              </option>
              <option className="option" value="Option 1">
                Last Week
              </option>
              <option className="option" value="Option 2">
                Last Month
              </option>
            </select>
          </div>
        ...
        {/* <thead className="">
                    <tr>
                        <th scope="col" className="py-3 px-6 text-xs font-bold tracking-wider text-left uppercase ">
                            Course Name
                        </th>
                        <th scope="col" className="py-3 px-6 text-xs font-bold tracking-wider text-left  uppercase ">
                            Price
                        ...
                        <th scope="col" className="py-3 px-6 text-xs font-bold tracking-wider text-right  uppercase ">
                            Total Amount
                        </th>
        ...
        <div className="bg-white  hidden sm:block ">
          {data
            .map((d) => (
              <div className="hover:bg-gray/10 grid grid-cols-12 rounded  sm:gap-6 gap-0  px-2 items-center">
                ...
                <div className="sm:py-4 py-2  text-sm font-medium text-right sm:text-left text-black col-span-6 sm:col-span-3 price">
                  {" "}
                  ₹{d.price}
                </div>
                <div className="sm:py-4 py-2 text-sm font-medium text-black flex items-center  col-span-6 sm:col-span-3">
                  {" "}
                  <p className="sm:hidden mr-2">Total Order - </p>{" "}
                  <p className="sm:bg-blue/30  text-blue/60  font-bold text inline-block sm:px-5 sm:p-2  rounded">
                    {" "}
                    {d.totalOrder}
                  </p>
                </div>
                <div className="sm:py-4 py-2 text-sm font-medium text-right col-span-6 sm:col-span-3">
                  <span className="sm:hidden mr-2 text-black">
                    Total Amount -{" "}
                  </span>{" "}
                  <p className="sm:text-black text-blue/60  text inline-block sm:px-5 sm:p-2  rounded text-black">
                    {" "}
                    ₹ {d.totalAmount}
                  </p>
                </div>
        ...
        <div className="bg-white block sm:hidden ">
            ...
            .map((d) => (
              <div className="hover:bg-gray/10 grid grid-cols-12 rounded    sm:gap-6 gap-0  px-2 items-center">
                ...
                <div className="sm:py-4 py-2 text-sm font-medium text-black flex items-center  col-span-6 sm:col-span-3">
                  {" "}
                  <p className="sm:hidden mr-2">Total Order - </p>{" "}
                  <p className="sm:bg-blue/20  text-blue/60 font-bold text inline-block sm:px-5 sm:p-2  rounded">
                    {" "}
                    {d.totalOrder}
                  </p>
                </div>
          ...
          {slice === 2 ? (
            <div
              style={{ cursor: "pointer", color: "#7D23E0", fontWeight: "500" }}
              onClick={() => setSlice(4)}
