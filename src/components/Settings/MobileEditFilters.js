...
const MobileEditFilters = () => {
  ...
  return (
    <div className="md:px-8 px-2 text-[#414141]">
      ...
      <div className="w-full">
        {showNumber === 0 && (
          <div className="w-full h-fit bg-white border border-[#C8C8C8]">
                ...
                <div
                  ...
                  onClick={() =>
                    data?.subOptions?.length !== 0
                      ? (setShowSubOptions(i), setShowNumber(2))
                      : false
                  }
                >
                  <div className="text-lg">{data.name}</div>
...
export default MobileEditFilters;
