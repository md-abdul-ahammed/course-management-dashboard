...
[
  ...
  { key: "cmd+up", command: "list.scrollUp", when: "listFocus && !inputFocus" },
  { key: "cmd+down", command: "list.select", when: "listFocus && !inputFocus" },
  ...
  { key: "cmd+k up", command: "views.moveViewUp", when: "focusedView != ''" },
  {
    key: "cmd+k",
