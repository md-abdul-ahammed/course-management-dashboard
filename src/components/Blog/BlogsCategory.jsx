...
import BlogCategories from "../Api/BlogCategories";
...
const BlogsCategory = ({
  ...
  const filterResult = (catItem) => {
    const result = BlogCategories.filter((cur) => {
    ...
    <div>
      <div className=" mt-16 lg:mt-20 xl:px-32">
        ...
        <div className="flex justify-center">
          ...
          >
            <AiOutlineSearch className="text-violet text-3xl" />
            <input
              type="text"
        ...
        {/* <div className="flex flex-col lg:flex-row text-xl gap-10 lg:gap-24 xl:gap-52 px-4 lg:px-20 xl:px-4 mt-10  ">
          <button
            className={
              category1
                ? "text-violet border-b-4 py-1 border-solid font-semibold"
        ...
        {data.map((item) => {
          ...
          return (
            <BlogPostCard
              ...
              postDate={postDate}
              read={read}
              initialtext="The blog title will come here in multiple lines as you can seehere in the blog section of our page blog title will come "
              blogLink="/blogs/blogsdetails"
              title={title}
              authorSrc={authorSrc}
              authorAlt={authorAlt}
