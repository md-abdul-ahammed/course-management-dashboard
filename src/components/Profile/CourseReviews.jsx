...
const CourseReviews = ({api}) => {
  ...
  const course = api?.filter(a => a.type === "course")
    return (
        <Container className='py-5 pb-8'>
        {
          course.length > 0 ? <div className="w-full  grid lg:grid-cols-2 gap-4  lg:py-6    lg:m-0">
          {course.map((a) => 
            ...
            <div className="flex justify-between">
              ...
              <div className='ml-3'>
                  <p className='text-2xl font-semibold'>UX Design Program</p>
        ...
        </div> : <NoData text={`You haven’t reviewed anything yet.`}></NoData>
        }
        </Container>
    );
};
