    ...
    <div className="absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 flex justify-center items-center  font-dm-sans px-4">
      ...
      >
        <button
          ...
          className="absolute shadow-md hover:shadow-lg hover:bg-red transition-colors rounded-full w-8 h-8 bg-violet top-2 right-2 text-white font-bold flex items-center justify-center"
        >
          <IoMdClose />
        </button>
        ...
        <div className="flex justify-center mt-6 space-x-4">
          <button
            ...
            className="font-medium bg-violet rounded-xl px-6 border-2 border-violet py-2 text-white text-lg"
          >
            {successText}
          </button>
          <button
            onClick={(e) => handleCancel(e)}
            className="border-2 border-violet font-medium bg-white rounded-xl px-6 py-2 text-violet text-lg"
          >
            {cancelText}
          </button>
        </div>
