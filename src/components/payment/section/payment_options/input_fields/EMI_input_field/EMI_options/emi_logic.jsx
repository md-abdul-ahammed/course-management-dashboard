                        ...
                        {toggle && <div>
                            <div className="flex justify-between">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-color-two font-medium text-base my-1 flex items-center"><img className="w-3 h-3 mr-2" src={PurpleRubee} />{currentValue.discount}</div>
                                        <div className="divider"></div>
                                        <div className="font-color-one text-base md:text-lg font-medium my-1 flex items-center"><img className="w-3 h-3 mr-2" src={GrayRubee} />{currentValue.total}</div>
                                    </div>
                            </div>    
