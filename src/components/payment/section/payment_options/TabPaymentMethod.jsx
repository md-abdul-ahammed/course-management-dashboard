      ...
      <div className='md:col-span-4'>
        {Data.map((d) => (
          <div
            ...
            className={
              d.id === active
                ? 'card flex p-4 my-4 rounded-2xl cursor-pointer text-white bg-color-one border border-purple-300'
                : 'card flex p-4 my-4 rounded-2xl  cursor-pointer hover:text-white  text-black duration-500 border border-purple-300'
            }
          >
            <div
              className={
                d.id === active
                  ...
                  : 'icon w-11 text-xl text-purple-700  mt-1'
              }
            >
              {d.icon}
            </div>
      ...
      <div className='md:col-span-8 h-screen'>
        {Data.map((d) => (
          <div
            key={d.id}
            active={active === d.id}
            className={d.id === active ? 'block' : 'hidden'}
          >
            {d.input}
          </div>
        ))}
